...
<div class="wp-block-group ftcunion-member-banner">
	<!-- wp:paragraph {"align":"center","style":{"spacing":{"padding":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}}},"backgroundColor":"foreground-headers","textColor":"background"} -->
	<p class="has-text-align-center has-background-color has-foreground-headers-background-color has-text-color has-background"
